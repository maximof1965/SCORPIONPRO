...
const TABLAS = {
  // INVENTARIO, RETIROS, SALIDAS, VENDIDO -> mas reciente arriba (NUMERO DESC).
  // Cualquier ingreso nuevo queda automaticamente en la primera fila.
  INVENTARIO: { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: false } },
  RETIROS:    { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: false } },
  SALIDAS:    { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: false } },
  VENDIDO:    { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: false } },
  // Tablas tipo bitacora -> mas reciente arriba
