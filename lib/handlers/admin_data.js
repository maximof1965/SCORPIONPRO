...
const TABLAS = {
  // INVENTARIO, RETIROS, SALIDAS, VENDIDO -> mismo orden que Sheets: NUMERO ascendente
  INVENTARIO: { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: true } },
  RETIROS:    { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: true } },
  SALIDAS:    { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: true } },
  VENDIDO:    { pk: ['NUMERO'], orden: { col: 'NUMERO', asc: true } },
